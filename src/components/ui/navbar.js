        ...
        <>
            ...
            <header className="bg-white shadow-sm sticky top-0 px-0 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                    <div className="flex justify-items-center items-center place-items-center space-x-4 sm:hidden">
                        <button onClick={()=>{setOpen(!open)}} type="button" class="inline-flex  items-center p-2 m-4 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
